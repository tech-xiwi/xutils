...
public class WlanMacHelper {
    private static final String TAG = "WlanMac";
    ...
    private static String getMacAddress0(Context context) {
        if (isAccessWifiStateAuthorized(context)) {
            ...
            try {
                ...
                Log.e(TAG, "getMacAddress0:" + e.toString());
            }
        }
        return "";
    ...
    private static boolean isAccessWifiStateAuthorized(Context context) {
        if (PackageManager.PERMISSION_GRANTED == context
            ...
            Log.e(TAG, "isAccessWifiStateAuthorized: access wifi state is enabled");
            return true;
        } else {
            return false;
        }
